...
<div class="absolute bottom-6 left-6 toolbar z-10">
	<form on:submit={insertDispatch}>
		...
		<div>
			...
			/>
			<button
				class="bg-indigo-500 text-indigo-200 px-3.5 py-1.5 rounded-md font-semibold cursor-pointer hover:bg-indigo-600 hover:text-indigo-300 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all duration-200 ease-in-out"
